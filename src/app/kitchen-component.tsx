...
const vanillaCupcakeStep0: RecipeStep = {
  ...
  description:
    "To start, preheat your oven to 350°F and insert liners into your cupcake pan. In a medium-sized bowl, combine flour, baking powder & salt and set aside.",
  order: 0,
};
...
export default function KitchenComponent() {
  const [currentRecipe, setCurrentRecipe] =
    useState<Recipe>(vanillaCupcakeRecipe);
